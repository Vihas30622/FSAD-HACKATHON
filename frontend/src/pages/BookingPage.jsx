    ...
    try {
      if (isMock) {
        const booking = {
          ...
          flight,
          seat_number: location.state?.selectedSeat,
          addOns,
          passenger: { ...formData },
          qrPayload: `${flight?.airline_name || 'Flight'}|${flight?.origin || ''}-${flight?.destination || ''}|${location.state?.selectedSeat || ''}`,
        }
      ...
      const response = await api.post('/bookings', {
        ...
        seatNumber: location.state?.selectedSeat,
        addOns,
      })
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-4">
          <div className="sticky top-24">
            <BookingSummary flight={flight} selectedSeat={location.state?.selectedSeat} addOns={addOns} />
          </div>
        </div>
      </div>
    </div>
